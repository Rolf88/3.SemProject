...
INSERT INTO flight (id, flightId, `capacity`, `departure`, price, traveltime, airline_id, destination_id, origin_id) VALUES (1, 'MCA2345', 100, CURRENT_TIMESTAMP, 200, 100, 1, 2, 1);

INSERT INTO flight (id, flightId, `capacity`, `departure`, price, traveltime, airline_id, destination_id, origin_id) VALUES (2, 'jkl5656', 100, CURRENT_TIMESTAMP, 205, 100, 1, 3, 1);

INSERT INTO flight (id, flightId, `capacity`, `departure`, price, traveltime, airline_id, destination_id, origin_id) VALUES (3, 'isk4568', 100, CURRENT_TIMESTAMP, 500, 100, 1, 4, 1);
