...
INSERT INTO flight (id, flightId, `capacity`, `departure`, price, traveltime, airline_id, destination_id, origin_id) VALUES (1, 'MCA2345', 100, CURRENT_TIMESTAMP, 20, 100, 1, 1, 2);